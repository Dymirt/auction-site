# Generated by Django 4.0 on 2022-03-31 22:21
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('comments', models.ManyToManyField(blank=True, related_name='commenters', to='auctions.Comment')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='auctions.user')),
                ('winner', models.ForeignKey(default=None, on_delete=django.db.models.deletion.SET_DEFAULT, related_name='victories', to='auctions.user')),
            ],
        ),
        migrations.AddField(
            model_name='comment',
